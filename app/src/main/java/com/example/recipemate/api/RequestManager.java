...
public class RequestManager {
	...
	public void getRandomRecipes(String category, RandomRecipeResponseListener listener) {
		...
		Call<RandomRecipeApiResponse> call = callRecipeApi.callRandomRecipes(context.getString(R.string.api_key), "10", category);
	...
	public void searchRecipes(String searchQuery, SearchRecipeResponseListener listener) {
		...
		Call<SearchRecipeApiResponse> call = callSearchRecipes.callSearchRecipes(context.getString(R.string.api_key), searchQuery, "10");
